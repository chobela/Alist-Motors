...
public class Cars extends AppCompatActivity {
    ...
    private List<Deals> albumList;



    private AVLoadingIndicatorView avii;

    String GET_JSON_DATA_HTTP_URL = "http://app-express.net/matebeto/json.php";
    String JSON_MEAL = "meal";
    String JSON_OLDPRICE = "oldprice";
    String JSON_PRICE = "price";
    String JSON_VENUE = "venue";
    String JSON_IMAGE = "image";
    String JSON_MEALID = "mealid";
